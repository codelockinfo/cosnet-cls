...
class SlideSection extends HTMLElement {
  ...
  initSlide() {
    ...
    const showLayout3 = _this?.dataset.showLayout3 === "true";
    const initialSlide = parseInt(_this?.dataset.initialSlide) || 0;

    this.globalSlide = new Swiper(_this, {
      slidesPerView: autoItem ? 'auto' : itemMobile,
      spaceBetween: spacing >= 15 ? 15 : spacing,
      centeredSlides: showLayout3,
      ...
      on: {
        ...
        slideChange: function () {
          ...
          if (
            ...
            const nextSection = _this.nextElementSibling;
            if (nextSection) {
        ...
        reachBeginning: function () {
          if (direction === "vertical" && mousewheel && loop) {
